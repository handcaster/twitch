...
class HelpTab:
    ...
    def __init__(self, manager: GUIManager, master: ttk.Widget):
        ...
        LinkLabel(
            about, link="https://github.com/handcaster", text="handcaster"
        ).grid(column=1, row=0, sticky="nsew")
        # About - repo link
        ttk.Label(about, text="Repository: ", anchor="e").grid(column=0, row=1, sticky="nsew")
        LinkLabel(
            about,
            link="https://github.com/handcaster",
            text="https://github.com/handcaster",
        ).grid(column=1, row=1, sticky="nsew")
        # About - donate
        ttk.Separator(
        ...
        LinkLabel(
            about,
            link="https://www.github.com/handcaster",
            text=(
